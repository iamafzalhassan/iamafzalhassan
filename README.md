...
| **[Debitter](https://github.com/iamafzalhassan/Debitter)**<br/><sub>Kotlin · Jetpack Compose · MVVM</sub> | Native Android app replacing a manual Word workflow for a customs clearing business | **Custom PDF layout engine** on `Canvas` with no third-party library · decimal-aligned tabular figures and automatic page overflow · `BigDecimal` money with one formatter shared by UI and PDF · non-destructive SQLite migrations · JUnit tests for money formatting and note totals |
| **[muwaqqit](https://github.com/iamafzalhassan/muwaqqit)**<br/><sub>Flutter · BLoC</sub> | Full-screen prayer-times board for masjid displays | Fully offline astronomical calculation · live Azan and Iqamah countdowns with day rollover · GPS with graceful fallback · layouts that scale from tablet to TV · unit tests for the countdown logic |
...
<sub>More: **[mmf](https://github.com/iamafzalhassan/mmf)** (Flutter web household registration form: Clean Architecture, BLoC, conditional validated fields, unit-tested submission rules)</sub>
